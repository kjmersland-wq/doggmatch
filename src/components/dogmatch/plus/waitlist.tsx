...
const copy = {
  ...
  de: {
    eyebrow: "Die Warteliste",
    title: "Erfahren Sie als Erste, wenn DoggMatch+ öffnet.",
    body: "Hinterlassen Sie Ihren Namen und Ihre E-Mail-Adresse, und wir senden Ihnen eine einzige ruhige Nachricht, wenn die Mitgliedschaft öffnet. Kein Newsletter, kein Lärm, und Sie können uns jederzeit bitten, Sie zu entfernen.",
    doneTitle: "Sie stehen auf der Liste.",
    doneBody: "Wir sagen Ihnen Bescheid, wenn DoggMatch+ bereit ist.",
    firstName: "Vorname",
    firstNamePlaceholder: "Kjell",
    ...
    consentPrefix:
      "Mit dem Beitritt sind Sie damit einverstanden, dass wir Ihren Namen und Ihre E-Mail speichern, um Ihnen mitzuteilen, wann DoggMatch+ öffnet. Nichts weiter, und niemals weitergegeben. Siehe unsere",
    consentLink: "Datenschutzhinweise auf unserer Über-uns-Seite",
    error: "Bei uns ist etwas schiefgelaufen. Bitte versuchen Sie es erneut.",
  },
  fr: {
    eyebrow: "La liste d'attente",
    title: "Soyez informé en premier de l'ouverture de DoggMatch+.",
    body: "Laissez votre prénom et votre e-mail, et nous vous enverrons un seul message discret quand l'adhésion ouvrira. Pas de newsletter, pas de bruit, et vous pouvez nous demander de vous retirer à tout moment.",
    doneTitle: "Vous êtes sur la liste.",
    doneBody: "Nous vous préviendrons quand DoggMatch+ sera prêt.",
    firstName: "Prénom",
    firstNamePlaceholder: "Kjell",
    ...
    consentPrefix:
      "En rejoignant la liste, vous acceptez que nous conservions votre prénom et votre e-mail afin de vous informer de l'ouverture de DoggMatch+. Rien d'autre, et jamais transmis. Consultez notre",
    consentLink: "avis de confidentialité sur notre page À propos",
    error: "Quelque chose s'est mal passé de notre côté. Veuillez réessayer.",
  },
  nl: {
    eyebrow: "De wachtlijst",
    title: "Kom als eerste te weten wanneer DoggMatch+ opent.",
    body: "Laat uw naam en e-mailadres achter en we sturen u één rustig bericht wanneer het lidmaatschap opent. Geen nieuwsbrief, geen gedoe, en u kunt ons op elk moment vragen u te verwijderen.",
    doneTitle: "U staat op de lijst.",
    doneBody: "We laten het u weten zodra DoggMatch+ klaar is.",
    firstName: "Voornaam",
    firstNamePlaceholder: "Kjell",
    email: "E-mailadres",
    emailPlaceholder: "u@voorbeeld.nl",
    submit: "Aanmelden voor de wachtlijst",
    submitBusy: "Een moment …",
    consentPrefix:
      "Door u aan te melden, gaat u ermee akkoord dat we uw naam en e-mail bewaren zodat we u kunnen laten weten wanneer DoggMatch+ opent. Verder niets, en nooit doorgegeven. Zie onze",
