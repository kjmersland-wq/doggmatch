...
const copy = {
  ...
  de: {
    ...
    title: "Abenteuer, die wirklich Spaß machen.",
    intro: "Hunde machen für Sie fast immer weiter, weit über den Punkt hinaus, an dem sie hätten aufhören sollen. Deshalb muss die Einschätzung von Ihnen kommen.",
    beforeEyebrow: "Vor einem großen Spaziergang",
    beforeTitle: "Ein wenig Vorbereitung.",
    hikingEyebrow: "Wandern",
    hikingTitle: "Was entscheidet, wie weit Sie gehen.",
    weatherEyebrow: "Wetter",
    weatherTitle: "Das Wetter entscheidet mehr als die Karte.",
    heat: "Hitze",
    cold: "Kälte",
    heatstrokeTitle: "Hitzschlag ist ein Notfall",
    heatstrokeBody: "Starkes Hecheln, das sich nicht legt, leuchtend rotes Zahnfleisch, Speicheln, Wackligkeit, Erbrechen oder Kollaps. Bringen Sie den Hund in den Schatten, bieten Sie Wasser an, kühlen Sie ihn mit lauwarmem — nicht eiskaltem — Wasser, und rufen Sie sofort einen Tierarzt an.",
    pawsEyebrow: "Pfoten",
    pawsTitle: "Prüfen Sie sie nach jedem großen Tag.",
    holidayEyebrow: "Ein gemeinsamer Urlaub",
    holidayTitle: "Was Sie mitnehmen sollten.",
    holidayBody: "Haken Sie es beim Packen ab. Es wird auf diesem Gerät gespeichert, also ist es beim nächsten Mal noch da.",
    abroadCta: "Ins Ausland reisen",
    placesCta: "Hundefreundliche Orte finden",
  },
  fr: {
    eyebrow: "En extérieur",
    title: "Des aventures qu'il appréciera vraiment.",
    intro: "Les chiens continueront presque toujours pour vous faire plaisir, bien au-delà du moment où ils auraient dû s'arrêter. C'est pourquoi le jugement doit être le vôtre.",
    beforeEyebrow: "Avant une grande sortie",
    beforeTitle: "Un peu de préparation.",
    hikingEyebrow: "Randonnée",
    hikingTitle: "Ce qui détermine jusqu'où vous irez.",
    weatherEyebrow: "Météo",
    weatherTitle: "La météo compte plus que la carte.",
    heat: "Chaleur",
    cold: "Froid",
    heatstrokeTitle: "Le coup de chaleur est une urgence",
    heatstrokeBody: "Halètement intense qui ne se calme pas, gencives rouge vif, bave, instabilité, vomissements ou effondrement. Mettez-le à l'ombre, offrez de l'eau, rafraîchissez-le avec de l'eau tiède — pas glacée — et appelez immédiatement un vétérinaire.",
    pawsEyebrow: "Coussinets",
    pawsTitle: "Vérifiez-les après chaque grande journée.",
    holidayEyebrow: "Des vacances ensemble",
    holidayTitle: "Quoi emporter.",
    holidayBody: "Cochez au fur et à mesure que vous faites vos valises. Cela s'enregistre sur cet appareil, donc ce sera encore là la prochaine fois.",
    abroadCta: "Voyager à l'étranger",
    placesCta: "Trouver des lieux accueillants pour chiens",
  },
  nl: {
    eyebrow: "Erop uit",
    title: "Avonturen waar hij echt van geniet.",
    intro: "Honden gaan voor u bijna altijd door, ver voorbij het punt waarop ze hadden moeten stoppen. Daarom moet het oordeel van u komen.",
    beforeEyebrow: "Voor een grote wandeling",
    beforeTitle: "Een beetje voorbereiding.",
    hikingEyebrow: "Wandelen",
    hikingTitle: "Wat bepaalt hoe ver u gaat.",
    weatherEyebrow: "Weer",
    weatherTitle: "Het weer bepaalt meer dan de kaart doet.",
    heat: "Hitte",
    cold: "Kou",
    heatstrokeTitle: "Hitteberoerte is een noodgeval",
    heatstrokeBody: "Zwaar hijgen dat niet tot rust komt, felrood tandvlees, kwijlen, wankelheid, braken of instorten. Breng hem in de schaduw, bied water aan, koel hem met lauw — niet ijskoud — water, en bel direct een dierenarts.",
    pawsEyebrow: "Pootjes",
    pawsTitle: "Controleer ze na elke grote dag.",
    holidayEyebrow: "Een vakantie samen",
    holidayTitle: "Wat u mee moet nemen.",
    holidayBody: "Vink het af terwijl u inpakt. Het wordt op dit apparaat opgeslagen, dus het staat er de volgende keer nog.",
