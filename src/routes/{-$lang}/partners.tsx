...
const seoCopy = {
  ...
  de: {
    title: "Werden Sie DoggMatch-Partner",
    description:
      "Bieten Sie DoggMatch+-Mitgliedern einen exklusiven Rabatt oder Vorteil. Keine Eintragungsgebühr, keine Provision — nur Ihr Unternehmen vor Hundehaltern, die bereits suchen.",
  },
  fr: {
    title: "Devenez partenaire DoggMatch",
    description:
      "Offrez aux membres DoggMatch+ une réduction ou un avantage exclusif. Aucun frais d'inscription, aucune commission — juste votre entreprise devant des propriétaires de chiens déjà en recherche.",
  },
  nl: {
    title: "Word DoggMatch-partner",
    description:
      "Geef DoggMatch+-leden een exclusieve korting of voordeel. Geen vermeldingskosten, geen commissie — gewoon uw bedrijf voor de ogen van hondenbezitters die al aan het zoeken zijn.",
  },
};
...
const copy = {
  ...
  de: {
    hero: {
      eyebrow: "Partner",
      title: "Stellen Sie Ihr Unternehmen Menschen vor, die gerade einen Hund bekommen haben.",
      body: "DoggMatch hilft Menschen, den richtigen Hund zu wählen und dann gut mit ihm zu leben. Unsere Mitglieder kaufen Betten, buchen Termine beim Hundefriseur, suchen einen Tierarzt und planen die erste Reise. Als Partner sind Sie es, den sie finden — mit einem Angebot, das sie zu Ihnen bringt.",
      cta: "DoggMatch-Partner werden",
      note: "Keine Eintragungsgebühr. Keine Provision. Ein echter Mensch antwortet.",
      imgAlt: "Eine Hundehalterin und ihr Golden Retriever stöbern in den Regalen eines unabhängigen Tierbedarfsladens",
    ...
    why: {
      ...
      vetAlt: "Ein Tierarzt hört das Herz eines Labradors ab, während der Halter daneben sitzt",
    },
    categories: {
      eyebrow: "Wen wir suchen",
      title: "Acht Arten von Unternehmen, nach denen unsere Mitglieder am häufigsten fragen.",
      body: "Wenn Ihre Arbeit den Alltag mit Hund besser macht und Sie es schätzen, dass wir Ihnen einen Freund schicken, gehören Sie hierher.",
      outdoorsAlt: "Ein Wanderer auf einem Küstenpfad bei Sonnenaufgang mit seinem Australian Shepherd",
      trainingAlt: "Ein Trainer kniet neben einem Border Collie während eines Kurses im Freien",
    },
    verification: {
      eyebrow: "An der Theke",
      title: "Ein Scan, und Sie wissen, dass es ein Mitglied ist.",
      body: "Jedes DoggMatch+-Mitglied trägt eine Karte mit einem QR-Code. Richten Sie eine beliebige Handykamera darauf, und eine Seite öffnet sich, die zeigt, ob die Mitgliedschaft aktiv ist und bis wann. Das ist alles, was sie zeigt — keine Namen, keine Adressen, nichts, was Sie speichern oder verwalten müssen.",
      points: [
        "Nichts zu installieren, kein Partner-Login zum Merken.",
        "Funktioniert mit einer gedruckten Karte oder der Karte auf dem Handy.",
        "Keine persönlichen Daten laufen über Ihre Kasse.",
      ...
      steps: [
        ...
        "Sie gewähren Ihr Angebot. Fertig in etwa fünf Sekunden.",
      ],
    },
    how: {
      eyebrow: "So funktioniert es",
      title: "Vier Schritte, ohne Kleingedrucktes zum Durchwühlen.",
      momentAlt: "Ein lächelnder Halter mit seinem Rettungshund, der sich vor einem Café an ihn lehnt",
    ...
    enquiry: {
      ...
      title: "Werden Sie DoggMatch-Partner.",
      body: "Erzählen Sie uns etwas über Ihr Unternehmen und was Sie anbieten möchten. Nichts hier verpflichtet Sie zu irgendetwas — es ist der Anfang eines Gesprächs.",
      thanksTitle: "Danke. Ihre Anfrage ist unterwegs.",
      thanksBody: "Wir haben eine kurze Bestätigung an Ihr Postfach gesendet, und ein echter Mensch wird sie lesen und so schnell wie möglich antworten.",
      again: "Eine weitere Anfrage senden",
      genericError: "Leider konnten wir Ihre Anfrage gerade nicht senden. Bitte versuchen Sie es in einem Moment erneut.",
      fields: {
        company: { label: "Unternehmen", placeholder: "Der Name Ihres Unternehmens" },
        ...
        message: { label: "Nachricht", placeholder: "Erzählen Sie uns von Ihrem Unternehmen, um wen Sie sich kümmern, und was Sie sonst wissen möchten." },
        honeypot: "Dieses Feld leer lassen",
      },
      sending: "Wird gesendet…",
      submit: "DoggMatch-Partner werden",
      privacy: "Wir verwenden Ihre Angaben nur, um Ihnen zu antworten. Zu nichts anderem.",
    },
  },
  fr: {
    hero: {
      ...
      body: "DoggMatch aide les gens à choisir le bon chien puis à bien vivre avec lui. Nos membres achètent des paniers, prennent rendez-vous chez le toiletteur, cherchent un vétérinaire et préparent leur premier voyage. En tant que partenaire, c'est vous qu'ils trouveront — avec une offre qui les fera venir chez vous.",
      cta: "Devenir partenaire DoggMatch",
      note: "Aucun frais d'inscription. Aucune commission. Une vraie personne vous répond.",
    ...
    why: {
      ...
      title: "Six raisons honnêtes d'être visible chez nous.",
    ...
    categories: {
      ...
      title: "Huit types d'entreprises que nos membres nous demandent le plus.",
      body: "Si votre travail améliore le quotidien avec un chien, et que vous appréciez que nous vous envoyions un ami, vous avez votre place ici.",
    ...
    verification: {
      eyebrow: "Au comptoir",
      title: "Un scan, et vous savez qu'il s'agit d'un membre.",
      body: "Chaque membre DoggMatch+ porte une carte avec un code QR. Pointez n'importe quel appareil photo de téléphone dessus, et une page s'ouvre indiquant si l'adhésion est active et jusqu'à quand. C'est tout ce qu'elle montre — aucun nom, aucune adresse, rien que vous ayez à stocker ou gérer.",
      points: [
        "Rien à installer, et aucun identifiant partenaire à retenir.",
        "Fonctionne depuis une carte imprimée ou la carte sur leur téléphone.",
        "Aucune donnée personnelle ne transite par votre caisse.",
        "Un badge Partenaire DoggMatch pour votre vitrine et votre site.",
      ],
      howTitle: "Comment cela se passe, en pratique",
      steps: [
        "Le membre mentionne DoggMatch+ et montre sa carte.",
        "Vous scannez le code QR avec n'importe quel téléphone.",
        "La page indique Actif, avec la date de validité.",
    ...
    how: {
      ...
      momentAlt: "Un propriétaire souriant avec son chien adopté appuyé contre lui devant un café",
      caption: "Nous préférons une courte liste de partenaires en qui nous avons vraiment confiance plutôt qu'une longue liste que personne ne lit.",
    },
    faq: {
      eyebrow: "Questions",
    ...
    enquiry: {
      ...
      thanksBody: "Nous avons envoyé une courte confirmation à votre boîte mail, et une vraie personne la lira et répondra dès que possible.",
      ...
      fields: {
        ...
        contact: { label: "Personne à contacter", placeholder: "À qui nous parlerons" },
        email: { label: "E-mail", placeholder: "vous@votreentreprise.fr" },
        country: { label: "Pays", placeholder: "Où vous êtes basé" },
        website: { label: "Site web", hint: "Facultatif", placeholder: "votreentreprise.fr" },
        category: { label: "Catégorie", placeholder: "Choisissez la plus proche", other: "Autre chose" },
        offer: { label: "Réduction ou avantage proposé", hint: "Une idée approximative suffit", placeholder: "par ex. 15 % de réduction sur harnais et laisses, ou une première consultation de toilettage gratuite" },
      ...
      privacy: "Nous utilisons vos informations uniquement pour vous répondre. Rien d'autre.",
    },
  },
  nl: {
    hero: {
      eyebrow: "Partners",
      title: "Laat uw bedrijf zien aan mensen die net een hond hebben.",
      body: "DoggMatch helpt mensen de juiste hond te kiezen en er daarna goed mee samen te leven. Onze leden kopen manden, boeken afspraken bij de trimsalon, zoeken een dierenarts en plannen hun eerste reisje weg. Als partner bent u degene die ze vinden — met een aanbod dat ze naar u toe brengt.",
      cta: "Word DoggMatch-partner",
      note: "Geen vermeldingskosten. Geen commissie. Een echt persoon antwoordt.",
      imgAlt: "Een hondenbezitter en haar golden retriever bekijken de schappen van een zelfstandige dierenwinkel",
      caption: "Het moment waarop een lid uw winkel binnenloopt, is de hele bedoeling.",
    },
    why: {
    ...
    categories: {
      ...
      title: "Acht soorten bedrijven waar onze leden het meest naar vragen.",
      body: "Als uw werk het dagelijks leven met een hond beter maakt, en u het waardeert dat we een vriend uw kant op sturen, hoort u hier thuis.",
      outdoorsAlt: "Een wandelaar op een kustpad bij zonsopgang met zijn Australische herder",
      trainingAlt: "Een trainer die naast een border collie hurkt tijdens een buitenles",
    },
    verification: {
      eyebrow: "Aan de balie",
      title: "Eén scan, en u weet dat het een lid is.",
      body: "Elk DoggMatch+-lid draagt een kaart met een QR-code. Richt er een willekeurige telefooncamera op, en er opent een pagina die laat zien of het lidmaatschap actief is en tot wanneer. Dat is alles wat het toont — geen namen, geen adressen, niets dat u hoeft te bewaren of bij te houden.",
      points: [
        "Niets te installeren, en geen partnerlogin om te onthouden.",
        "Werkt vanaf een uitgeprinte kaart of de kaart op hun telefoon.",
        "Er gaan geen persoonsgegevens door uw kassa.",
        "Een DoggMatch-partnerbadge voor uw etalage en website.",
      ],
      howTitle: "Zo gaat het in de praktijk",
      steps: [
        "Het lid noemt DoggMatch+ en toont zijn kaart.",
        "U scant de QR-code met een willekeurige telefoon.",
        "De pagina toont Actief, met de datum tot wanneer.",
        "U past uw aanbod toe. Klaar in ongeveer vijf seconden.",
      ],
    },
    how: {
      eyebrow: "Zo werkt het",
      title: "Vier stappen, zonder kleine lettertjes om doorheen te ploeteren.",
      momentAlt: "Een glimlachende eigenaar met zijn asielhond die tegen hem aan leunt buiten een café",
      caption: "We hebben liever een korte lijst met partners die we echt vertrouwen dan een lange die niemand leest.",
    },
    faq: {
      eyebrow: "Vragen",
      title: "Waar de meeste bedrijven ons het eerst naar vragen.",
    },
    enquiry: {
      eyebrow: "Neem contact op",
      title: "Word DoggMatch-partner.",
      body: "Vertel ons iets over uw bedrijf en wat u zou willen aanbieden. Niets hier verplicht u tot iets — het is het begin van een gesprek.",
      thanksTitle: "Bedankt. Uw aanvraag is onderweg.",
      thanksBody: "We hebben een korte bevestiging naar uw inbox gestuurd, en een echt persoon leest hem en reageert zo snel mogelijk.",
      again: "Nog een aanvraag versturen",
      genericError: "Sorry, we konden uw aanvraag nu niet verzenden. Probeer het straks nog eens.",
      fields: {
        company: { label: "Bedrijf", placeholder: "De naam van uw bedrijf" },
        contact: { label: "Contactpersoon", placeholder: "Met wie we zullen spreken" },
        email: { label: "E-mail", placeholder: "u@uwbedrijf.nl" },
        country: { label: "Land", placeholder: "Waar u gevestigd bent" },
        website: { label: "Website", hint: "Optioneel", placeholder: "uwbedrijf.nl" },
        category: { label: "Categorie", placeholder: "Kies de dichtstbijzijnde", other: "Iets anders" },
        offer: { label: "Voorgestelde korting of voordeel", hint: "Een ruw idee is prima", placeholder: "bijv. 15% korting op tuigjes en lijnen, of een gratis eerste trimconsult" },
        message: { label: "Bericht", placeholder: "Vertel ons over uw bedrijf, voor wie u zorgt, en alles wat u wilt weten." },
        honeypot: "Laat dit veld leeg",
      },
      sending: "Verzenden…",
      submit: "Word DoggMatch-partner",
      privacy: "We gebruiken uw gegevens alleen om u te antwoorden. Nergens anders voor.",
    },
  },
} as const;
...
const partnerFeatureCopy = {
  ...
  de: {
    hero: {
      reciprocal: "Im Gegenzug erhalten Ihre eigenen Kunden 25 % Rabatt auf DoggMatch+ für das erste Jahr. Keine Eintragsgebühr. Keine Provision. Sie entscheiden, was Sie unseren Mitgliedern anbieten.",
      secondaryCta: "Lassen Sie uns sprechen",
    },
    mutual: {
      eyebrow: "Ein Vorteil für beide Seiten",
      title: "Einfach für Sie. Nützlich für Ihre Kunden.",
      body: "Sie entscheiden, welchen Vorteil Sie unseren Mitgliedern geben möchten. Im Gegenzug geben wir Ihren Kunden 25 % Rabatt auf DoggMatch+ für das erste Jahr.",
      ...
      imageAlt: "Eine Zoohändlerin zeigt einem zufriedenen Kunden mit seinem Golden Retriever DoggMatch auf ihrem Telefon",
      caption: "Sie behalten die Kontrolle über Ihr Angebot. Wir kümmern uns um den Erstjahresrabatt Ihrer Kunden.",
    },
  },
  fr: {
    hero: {
      reciprocal: "En retour, vos propres clients bénéficient de 25 % de réduction sur DoggMatch+ pour leur première année. Aucun frais d'inscription. Aucune commission. Vous décidez de ce que vous offrez à nos membres.",
      secondaryCta: "Discutons-en",
    },
    mutual: {
      eyebrow: "Un bénéfice pour les deux parties",
      title: "Simple pour vous. Utile pour vos clients.",
      body: "Vous décidez de l'avantage que vous souhaitez offrir à nos membres. En retour, nous offrons à vos clients 25 % de réduction sur DoggMatch+ pour leur première année.",
      customerTitle: "Pour votre client",
      customerSteps: ["Vous partagez votre code partenaire unique", "Il rejoint DoggMatch+", "Il reçoit 25 % de réduction sur sa première année"],
      memberTitle: "Pour un membre DoggMatch+",
      memberSteps: ["Il présente sa carte de membre QR", "Vous la vérifiez en quelques secondes", "Il reçoit l'avantage que vous avez choisi"],
      imageAlt: "Une commerçante en animalerie montre DoggMatch sur son téléphone à un client satisfait avec son golden retriever",
      caption: "Vous gardez le contrôle de votre offre. Nous nous occupons de la réduction de première année de vos clients.",
    },
  },
  nl: {
    hero: {
      reciprocal: "In ruil daarvoor krijgen uw eigen klanten 25% korting op DoggMatch+ voor hun eerste jaar. Geen vermeldingskosten. Geen commissie. U bepaalt wat u onze leden aanbiedt.",
      secondaryCta: "Laten we praten",
    },
    mutual: {
      eyebrow: "Een voordeel voor beide kanten",
      title: "Eenvoudig voor u. Nuttig voor uw klanten.",
      body: "U bepaalt welk voordeel u onze leden wilt geven. In ruil daarvoor geven wij uw klanten 25% korting op DoggMatch+ voor hun eerste jaar.",
      customerTitle: "Voor uw klant",
      customerSteps: ["U deelt uw unieke partnercode", "Ze worden lid van DoggMatch+", "Ze krijgen 25% korting op hun eerste jaar"],
      memberTitle: "Voor een DoggMatch+-lid",
      memberSteps: ["Ze tonen hun QR-ledenkaart", "U controleert deze in een paar seconden", "Ze ontvangen het voordeel dat u heeft gekozen"],
      imageAlt: "Een dierenwinkeleigenaar laat DoggMatch op haar telefoon zien aan een tevreden klant met zijn golden retriever",
      caption: "U houdt de controle over uw aanbod. Wij zorgen voor de eerstejaarskorting van uw klanten.",
    },
  },
} as const;
