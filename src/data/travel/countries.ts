...
const source = (
  ...
  lastChecked: string,
  category = "Pet travel",
): OfficialSource => ({ name, url, country, lastChecked, category });
...
export const countries: Country[] = [
  ...
  },
  {
    ...
    entry: {
      fromEu: {
        rules: [
          { id: "microchip", level: "required", title: "Microchip", detail: "An ISO-standard microchip, recorded on the forms you submit." },
          { id: "age", level: "required", title: "Minimum age", detail: "The CDC applies a minimum age for dogs entering the United States. Check the current figure before booking." },
          { id: "form", level: "required", title: "CDC import form", detail: "An online CDC Dog Import Form is required, submitted before travel, with the receipt carried with you." },
          { id: "rabies", level: "required", title: "Rabies documentation", detail: "What's required depends on where the dog has been in the previous six months. The CDC page walks through each case." },
        ],
        quarantine:
