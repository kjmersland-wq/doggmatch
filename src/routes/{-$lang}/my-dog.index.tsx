...
const copy = {
  ...
  de: {
    ...
    routineItems: [
      ...
      { id: "brush", label: "Kurz bürsten", hint: "Und dabei nach Knoten oder Verfilzungen tasten" },
    ...
    sections: [
      ...
      { to: "/train", label: "Training", line: "Die kurze Einheit von heute und woran ihr gerade arbeitet" },
      ...
      { to: "/train/library", label: "Verhalten", line: "Ziehen, Hochspringen, Bellen — eine Lektion nach der anderen" },
      { to: "/dog-life", label: "Hundeleben", line: "Orte zum Hingehen und Dinge zu tun in der Nähe" },
      { to: "/my-dog/print", label: "Dokumente", line: "Drucke den Plan, das Paket oder eine Notiz für die Hundesitterin" },
    ],
    today: "Heute",
    ofCount: "{done} von {total}",
    todayIntro: "Nichts hiervon muss perfekt sein. Hak ab, was du erledigt hast — morgen fängt es von vorn an.",
    ...
    printSaveBody: "Eine Profilkarte für die Hundesitterin, ein Fütterungsplan für den Kühlschrank oder das ganze Hundepaket auf einmal.",
    printSaveCta: "Etwas zum Ausdrucken erstellen",
    contactsInfo: "Kontakte & Informationen",
    contactsInfoBody: "Die Nummer der Tierarztpraxis, der Chip, die Allergien — alles, wonach du in der Eile nicht suchen möchtest.",
    contactsInfoCta: "Angaben ausfüllen",
    vetVisits: "Tierarztbesuche",
    vetVisitsBody: "Schreib auf, was dir aufgefallen ist und was du fragen möchtest, und nimm es mit.",
    ...
    foodPortionsBody: "Wie viel du füttern solltest, wie oft, und wie du das Futter wechselst, ohne jemandem den Magen zu verderben.",
    foodPortionsMeta: "Berechnet eine Tagesmenge für deinen Hund",
    weightShapeTitle: "Gewicht & Kondition",
    weightShapeBody: "Lerne den Handcheck, den Tierärzte verwenden, und führe eine einfache Aufzeichnung über die Zeit.",
    weightShapeMeta: "Dauert etwa eine Minute im Monat",
    canEatTitle: "Darf mein Hund das essen?",
    canEatBody: "Eine ruhige, durchsuchbare Antwort für den Moment, in dem etwas auf dem Küchenboden landet.",
  ...
  fr: {
    ...
    routineItems: [
      ...
      { id: "brush", label: "Petit coup de brosse", hint: "Et un passage de la main pour repérer nœuds ou grosseurs" },
    ...
    sections: [
      { to: "/my-dog/week", label: "Ma semaine", line: "Promenades, éducation, alimentation et soins, jour après jour" },
      { to: "/train", label: "Éducation", line: "La courte session du jour et ce sur quoi vous travaillez" },
      { to: "/my-dog/nutrition", label: "Alimentation", line: "Portions, repas et changement de nourriture en toute sécurité" },
      { to: "/my-dog/care/everyday-check", label: "Santé", line: "Le contrôle rapide qui détecte les problèmes tôt" },
      { to: "/my-dog/care/dental", label: "Dentaire", line: "Dents et gencives, en moins d'une minute par jour" },
      { to: "/my-dog/care/coat", label: "Pelage & soins", line: "Brossage, bain et connaître le type de pelage" },
      { to: "/my-dog/care/paws", label: "Coussinets & griffes", line: "Coussinets, griffes et ce que l'hiver leur fait" },
      { to: "/my-dog/weight", label: "Poids", line: "Le contrôle à la main, et un suivi simple" },
      { to: "/my-dog/care/wellbeing", label: "Activité", line: "Mouvement, reniflage et assez de repos" },
      { to: "/train/library", label: "Comportement", line: "Tirer en laisse, sauter, aboyer — une leçon à la fois" },
      { to: "/dog-life", label: "Vie de chien", line: "Des endroits où aller et des choses à faire dans le coin" },
      { to: "/my-dog/print", label: "Documents", line: "Imprimez le plan, le dossier ou un mot pour la personne qui le garde" },
    ],
    today: "Aujourd'hui",
    ofCount: "{done} sur {total}",
    todayIntro: "Rien de tout ça ne doit être parfait. Cochez ce que vous avez fait — ça se remet à zéro demain.",
    ...
    weekIntro: "Les prochains jours, établis selon l'âge, la race de votre chien et le rythme de vos journées.",
    comingRoundAgain: "Ce qui revient",
    calendarIntro: "Un petit rappel bienveillant, jamais un reproche. Cochez une fois que c'est fait.",
    printSave: "Imprimer & conserver",
    printSaveBody: "Une fiche pour la personne qui le garde, un plan de repas pour le frigo, ou tout le Dossier chien en une fois.",
    printSaveCta: "Créer un document à imprimer",
    contactsInfo: "Contacts & informations",
    contactsInfoBody: "Le numéro du vétérinaire, la puce, les allergies — tout ce que vous détesteriez chercher dans l'urgence.",
    ...
    foodPortionsBody: "Combien nourrir, à quelle fréquence, et comment changer de nourriture sans déranger l'estomac de personne.",
  ...
  nl: {
    ...
    sections: [
      { to: "/my-dog/week", label: "Mijn week", line: "Wandelen, training, eten en verzorging, dag na dag" },
      { to: "/train", label: "Training", line: "De korte oefening van vandaag en waar je aan werkt" },
      { to: "/my-dog/nutrition", label: "Voeding", line: "Porties, maaltijden en veilig overstappen van voer" },
      { to: "/my-dog/care/everyday-check", label: "Gezondheid", line: "De snelle check die dingen vroeg opmerkt" },
      { to: "/my-dog/care/dental", label: "Gebit", line: "Tanden en tandvlees, in minder dan een minuut per dag" },
      { to: "/my-dog/care/coat", label: "Vacht & verzorging", line: "Borstelen, wassen en het vachttype kennen" },
      { to: "/my-dog/care/paws", label: "Poten & nagels", line: "Zooltjes, nagels en wat de winter ermee doet" },
      { to: "/my-dog/weight", label: "Gewicht", line: "De handmatige check, en een simpel overzicht" },
      { to: "/my-dog/care/wellbeing", label: "Activiteit", line: "Beweging, snuffelen en genoeg rust" },
      { to: "/train/library", label: "Gedrag", line: "Trekken, opspringen, blaffen — één les tegelijk" },
      { to: "/dog-life", label: "Hondenleven", line: "Plekken om heen te gaan en dingen te doen in de buurt" },
      { to: "/my-dog/print", label: "Documenten", line: "Print het plan, het pakket of een briefje voor de oppas" },
    ],
    today: "Vandaag",
    ofCount: "{done} van {total}",
    todayIntro: "Niets hiervan hoeft perfect te zijn. Vink af wat je hebt gedaan — morgen begint het weer opnieuw.",
    ...
    weekIntro: "De komende dagen, samengesteld op basis van leeftijd, ras en hoe druk jouw dagen zijn.",
    ...
    printSaveBody: "Een profielkaart voor de oppas, een voerschema voor de koelkast, of het hele Hondenpakket in één keer.",
    printSaveCta: "Iets maken om te printen",
    contactsInfo: "Contacten & informatie",
    contactsInfoBody: "Het nummer van de dierenarts, de chip, de allergieën — alles wat je liever niet in paniek hoeft op te zoeken.",
    ...
    foodPortionsBody: "Hoeveel je moet voeren, hoe vaak, en hoe je van voer wisselt zonder iemands maag van streek te maken.",
    foodPortionsMeta: "Berekent een dagelijkse hoeveelheid voor je hond",
    weightShapeTitle: "Gewicht & conditie",
    weightShapeBody: "Leer de handmatige check die dierenartsen gebruiken en houd een simpel overzicht bij in de tijd.",
