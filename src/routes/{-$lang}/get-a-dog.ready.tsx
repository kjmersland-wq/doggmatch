...
const copy = {
  ...
  de: {
    eyebrow: "Passt ein Hund zu Ihrem Leben?",
    of: "von",
    ...
    answersOnDevice: "Ihre Antworten bleiben auf diesem Gerät.",
    resultEyebrow: "Was wir denken",
    basedOn: "Basierend auf",
    resultNote: "Antworten. Das ist kein Punktestand — es entscheidet nur, welche von drei ehrlichen Antworten wir Ihnen geben.",
    notesTitle: "Ein paar Dinge, die sich vorher zu klären lohnen",
    notesBody:
      "Keiner dieser Punkte spricht gegen einen Hund. Es sind Dinge, die sich jetzt viel leichter regeln lassen als später.",
    weveKept: "Wir haben die",
    answersHelp: "Antworten aufbewahrt, die beim Matching helfen, damit Meinen Hund finden nicht erneut danach fragt.",
    findMyDog: "Meinen Hund finden",
    puppyOrAdult: "Welpe oder erwachsen?",
    changeAnswers: "Meine Antworten ändern",
    oneMoreThing: "Noch etwas",
    oneMoreThingBody:
      "Nichts hiervon ist ein Urteil, und nichts wird irgendwo außer auf diesem Gerät gespeichert. Wenn jetzt nicht der richtige Zeitpunkt ist, wird ein Hund trotzdem da sein, wenn er es ist.",
  },
  fr: {
    ...
    notesBody:
      "Aucun de ces points n'est une raison de ne pas avoir de chien. Ce sont des choses bien plus faciles à organiser maintenant que plus tard.",
    weveKept: "Nous avons conservé les",
    answersHelp: "réponses qui aident au matching, donc Trouver mon chien ne vous les redemandera pas.",
    findMyDog: "Trouver mon chien",
    puppyOrAdult: "Chiot ou adulte ?",
    changeAnswers: "Modifier mes réponses",
    oneMoreThing: "Encore une chose",
    oneMoreThingBody:
      "Rien ici n'est un jugement, et rien n'est conservé ailleurs que sur cet appareil. Si ce n'est pas le bon moment maintenant, un chien sera toujours là quand ce le sera.",
  },
  nl: {
    eyebrow: "Past een hond bij uw leven?",
    of: "van",
    progress: "Voortgang",
    back: "Terug",
    seeWhatIThink: "Bekijk wat wij denken",
    continueBtn: "Doorgaan",
    noPassMark: "Er is hier geen minimumscore, en geen fout antwoord.",
    answersOnDevice: "Uw antwoorden blijven op dit apparaat.",
    resultEyebrow: "Wat wij denken",
    basedOn: "Gebaseerd op",
    resultNote: "antwoorden. Dit is geen score — het bepaalt alleen welk van drie eerlijke antwoorden we u geven.",
    notesTitle: "Een paar dingen die het waard zijn om eerst te regelen",
    notesBody:
      "Geen van deze zaken zijn redenen om geen hond te nemen. Het zijn dingen die nu veel makkelijker te regelen zijn dan later.",
    ...
    oneMoreThingBody:
      "Niets hiervan is een oordeel, en niets wordt ergens anders opgeslagen dan op dit apparaat. Als nu niet het juiste moment is, is er nog steeds een hond wanneer dat wel zo is.",
  },
} as const;
