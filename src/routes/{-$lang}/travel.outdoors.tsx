...
const copy = {
  en: {
    ...
    intro:
      "Dogs will almost always keep going for you, well past the point they should have stopped. That's why the judgement has to be yours.",
    ...
    heatstrokeBody:
      "Heavy panting that won't settle, bright red gums, drooling, wobbliness, vomiting or collapse. Get them into shade, offer water, cool them with tepid — not icy — water, and ring a vet straight away.",
    pawsEyebrow: "Paws",
    pawsTitle: "Check them after every big day.",
    holidayEyebrow: "A holiday together",
    holidayTitle: "What to take.",
    holidayBody:
      "Tick it off as you pack. It saves on this device, so it'll still be here next time.",
  ...
  no: {
    ...
    intro:
      "Hunder holder nesten alltid på for din skyld, godt forbi punktet der de burde stoppet. Derfor må vurderingen være din.",
    ...
    heatstrokeBody:
      "Tung pusting som ikke roer seg, klarrøde tannkjøtt, sikling, ustøhet, oppkast eller kollaps. Få dem i skygge, tilby vann, kjøl dem ned med lunkent — ikke iskaldt — vann, og ring veterinæren med en gang.",
    pawsEyebrow: "Poter",
    pawsTitle: "Sjekk dem etter hver store tur.",
    holidayEyebrow: "En ferie sammen",
    holidayTitle: "Hva dere bør ta med.",
    holidayBody:
      "Kryss av mens dere pakker. Det lagres på denne enheten, så det ligger her neste gang også.",
  ...
  pl: {
    ...
    intro:
      "Psy niemal zawsze będą kontynuować marsz dla ciebie, długo po tym, jak powinny się zatrzymać. Dlatego to ty musisz ocenić sytuację.",
    ...
    heatstrokeBody:
      "Ciężkie dyszenie, które nie ustępuje, jaskrawoczerwone dziąsła, ślinienie się, chwianie, wymioty lub zapaść. Zaprowadź psa w cień, podaj wodę, schładzaj letnią — nie lodowatą — wodą i natychmiast zadzwoń do weterynarza.",
    pawsEyebrow: "Łapy",
    pawsTitle: "Sprawdzaj je po każdym dużym dniu.",
    holidayEyebrow: "Wspólny wyjazd",
    holidayTitle: "Co zabrać ze sobą.",
    holidayBody:
      "Odhaczaj podczas pakowania. Zapisuje się to na tym urządzeniu, więc będzie tu też następnym razem.",
  ...
  dk: {
    ...
    intro:
      "Hunde vil næsten altid blive ved for din skyld, godt forbi det punkt, hvor de burde have stoppet. Derfor skal vurderingen være din.",
    beforeEyebrow: "Før en stor tur",
    ...
    heatstrokeBody:
      "Tung vejrtrækning der ikke falder til ro, klart røde tandkød, savlen, ustøhed, opkastning eller kollaps. Få dem i skygge, tilbyd vand, køl dem ned med lunkent — ikke iskoldt — vand, og ring straks til dyrlægen.",
    pawsEyebrow: "Poter",
    pawsTitle: "Tjek dem efter hver stor dag.",
    holidayEyebrow: "En ferie sammen",
    holidayTitle: "Hvad I skal have med.",
    holidayBody:
      "Kryds af, mens I pakker. Det gemmes på denne enhed, så det er her igen næste gang.",
  ...
  se: {
    ...
    intro:
      "Hundar fortsätter nästan alltid för din skull, långt förbi punkten där de borde ha stannat. Därför måste bedömningen vara din.",
    ...
    heatstrokeBody:
      "Kraftig flåsning som inte lugnar sig, klarröda tandkött, dregel, ostadighet, kräkningar eller kollaps. Få dem i skugga, erbjud vatten, kyl ner dem med ljummet — inte iskallt — vatten, och ring veterinären direkt.",
    pawsEyebrow: "Tassar",
    pawsTitle: "Kolla dem efter varje stor dag.",
    holidayEyebrow: "En semester tillsammans",
    holidayTitle: "Vad ni ska ta med.",
    holidayBody:
      "Bocka av allteftersom ni packar. Det sparas på den här enheten, så det finns kvar nästa gång.",
    ...
    intro:
      "Koirat jatkavat lähes aina sinun vuoksesi, kauan sen jälkeen kun niiden olisi pitänyt lopettaa. Siksi arvion täytyy olla sinun.",
    ...
    heatstrokeBody:
      "Voimakas läähätys, joka ei rauhoitu, kirkkaanpunaiset ikenet, kuolaaminen, horjuminen, oksentelu tai romahtaminen. Vie koira varjoon, tarjoa vettä, jäähdytä sitä haalealla — ei jääkylmällä — vedellä, ja soita heti eläinlääkärille.",
    pawsEyebrow: "Tassut",
    pawsTitle: "Tarkista ne jokaisen ison päivän jälkeen.",
    holidayEyebrow: "Yhteinen loma",
    holidayTitle: "Mitä ottaa mukaan.",
    holidayBody:
      "Merkitse valmiiksi pakatessasi. Se tallentuu tälle laitteelle, joten se on täällä myös ensi kerralla.",
  ...
  de: {
    ...
    intro:
      "Hunde machen für dich fast immer weiter, weit über den Punkt hinaus, an dem sie hätten aufhören sollen. Deshalb musst du die Einschätzung treffen.",
    ...
    heatstrokeBody:
      "Starkes Hecheln, das sich nicht legt, leuchtend rotes Zahnfleisch, Sabbern, Wackeligkeit, Erbrechen oder Zusammenbruch. Bring ihn in den Schatten, biete Wasser an, kühle ihn mit lauwarmem — nicht eiskaltem — Wasser und ruf sofort den Tierarzt an.",
    pawsEyebrow: "Pfoten",
    pawsTitle: "Nach jedem großen Tag prüfen.",
    holidayEyebrow: "Gemeinsam im Urlaub",
    holidayTitle: "Was ihr mitnehmen solltet.",
    holidayBody:
      "Hak es beim Packen ab. Es wird auf diesem Gerät gespeichert, also ist es beim nächsten Mal noch da.",
  ...
  fr: {
    ...
    intro:
      "Les chiens continuent presque toujours pour vous, bien au-delà du moment où ils auraient dû s'arrêter. C'est pourquoi le jugement doit être le vôtre.",
    ...
    heatstrokeBody:
      "Halètement fort qui ne se calme pas, gencives rouge vif, salivation, instabilité, vomissements ou effondrement. Mettez-le à l'ombre, proposez de l'eau, rafraîchissez-le avec de l'eau tiède — pas glacée — et appelez immédiatement un vétérinaire.",
    pawsEyebrow: "Pattes",
    pawsTitle: "Vérifiez-les après chaque grande journée.",
    holidayEyebrow: "Des vacances ensemble",
    holidayTitle: "Quoi emporter.",
    holidayBody:
      "Cochez au fur et à mesure que vous faites vos bagages. Cela s'enregistre sur cet appareil, donc ce sera encore là la prochaine fois.",
  ...
  nl: {
    ...
    intro:
      "Honden gaan voor jou vrijwel altijd door, ver voorbij het punt waarop ze hadden moeten stoppen. Daarom moet het oordeel bij jou liggen.",
    ...
    heatstrokeBody:
      "Heftig hijgen dat niet bedaart, felrood tandvlees, kwijlen, wankelheid, braken of instorten. Breng hem in de schaduw, bied water aan, koel hem af met lauw — niet ijskoud — water, en bel meteen een dierenarts.",
    pawsEyebrow: "Poten",
    pawsTitle: "Controleer ze na elke grote dag.",
    holidayEyebrow: "Samen op vakantie",
    holidayTitle: "Wat je moet meenemen.",
    holidayBody:
      "Vink het af terwijl je pakt. Het wordt op dit apparaat opgeslagen, dus het staat er de volgende keer nog.",
    ...
    <div className="pb-24">
      ...
      <Section className="bg-surface pt-0">
        <div className="container-page pt-20 md:pt-28">
          <SectionHead eyebrow={c.weatherEyebrow} title={c.weatherTitle} body={weather.note} />
