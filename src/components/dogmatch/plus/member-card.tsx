...
const copy = {
  ...
  dk: {
    ...
    ended: "Afsluttet",
    validThrough: "Gyldig til",
    checkThisCard: "Tjek dette kort",
    backBody: "Scan koden, eller gå til doggmatch.com/verify og indtast medlems-ID'et nedenfor.",
    fineprint: "Dette kort tilhører personen nævnt på forsiden. Det er ikke et betalingskort.",
    verifyAlt: (id: string) => `Verifikationskode for ${id}`,
  },
  se: {
    plusMember: "+ Medlem",
    member: "Medlem",
    ...
    active: "Aktivt",
    ended: "Avslutat",
    validThrough: "Giltigt till",
    checkThisCard: "Kontrollera det här kortet",
    backBody: "Skanna koden, eller gå till doggmatch.com/verify och skriv in medlems-ID:t nedan.",
    fineprint: "Det här kortet tillhör personen som anges på framsidan. Det är inte ett betalkort.",
    verifyAlt: (id: string) => `Verifieringskod för ${id}`,
  },
  fi: {
    plusMember: "+ Jäsen",
    member: "Jäsen",
    ...
    active: "Aktiivinen",
    ended: "Päättynyt",
    validThrough: "Voimassa",
    checkThisCard: "Tarkista tämä kortti",
    backBody: "Skannaa koodi tai käy osoitteessa doggmatch.com/verify ja kirjoita alla oleva jäsentunnus.",
    fineprint: "Tämä kortti kuuluu etupuolella mainitulle henkilölle. Se ei ole maksukortti.",
    verifyAlt: (id: string) => `Vahvistuskoodi tunnukselle ${id}`,
  },
  de: {
    plusMember: "+ Mitglied",
    member: "Mitglied",
    ...
    checkThisCard: "Diese Karte prüfen",
    backBody: "Scannen Sie den Code oder besuchen Sie doggmatch.com/verify und geben Sie die unten stehende Mitglieds-ID ein.",
    fineprint: "Diese Karte gehört der auf der Vorderseite genannten Person. Es ist keine Zahlungskarte.",
    verifyAlt: (id: string) => `Prüfcode für ${id}`,
  },
  fr: {
    plusMember: "+ Membre",
    member: "Membre",
    memberId: "Identifiant de membre",
    status: "Statut",
    active: "Actif",
    ended: "Terminé",
    validThrough: "Valable jusqu'au",
    checkThisCard: "Vérifier cette carte",
    backBody: "Scannez le code, ou rendez-vous sur doggmatch.com/verify et saisissez l'identifiant de membre ci-dessous.",
    fineprint: "Cette carte appartient à la personne nommée au recto. Ce n'est pas une carte de paiement.",
    verifyAlt: (id: string) => `Code de vérification pour ${id}`,
  },
  nl: {
    plusMember: "+ Lid",
    member: "Lid",
    ...
    checkThisCard: "Controleer deze pas",
    backBody: "Scan de code, of ga naar doggmatch.com/verify en typ de onderstaande lid-ID in.",
    fineprint: "Deze pas is van de persoon die aan de voorkant staat vermeld. Het is geen betaalpas.",
    verifyAlt: (id: string) => `Verificatiecode voor ${id}`,
  },
} as const;
