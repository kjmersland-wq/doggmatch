...
const copy = {
  ...
  de: {
    ...
    letsSetUp: "Richten wir Sie ein",
    intro:
      "Ein Konto brauchen Sie nur für DoggMatch+ und alles, was wir für Sie speichern. Alles andere bei DoggMatch bleibt kostenlos und frei zugänglich.",
    ...
    signUpNotice: "Fast geschafft — prüfen Sie Ihr Postfach und bestätigen Sie Ihre E-Mail-Adresse.",
    genericError: "Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut.",
    googleError: "Die Anmeldung mit Google hat gerade nicht geklappt. Bitte versuchen Sie es erneut.",
  },
  fr: {
    ...
    intro:
      "Un compte n'est nécessaire que pour DoggMatch+ et tout ce que nous conservons pour vous. Tout le reste sur DoggMatch reste gratuit et accessible.",
    ...
    signUpNotice: "Presque terminé — vérifiez votre boîte de réception et confirmez votre adresse e-mail.",
    genericError: "Une erreur s'est produite. Veuillez réessayer.",
    googleError: "La connexion avec Google n'a pas fonctionné à l'instant. Veuillez réessayer.",
  },
  nl: {
    eyebrow: "Uw account",
    welcomeBack: "Welkom terug",
    letsSetUp: "Laten we u instellen",
    intro:
      "U heeft alleen een account nodig voor DoggMatch+ en alles wat we voor u bewaren. Al het andere op DoggMatch blijft gratis en open.",
    ...
    signUpNotice: "Bijna klaar — controleer uw inbox en bevestig uw e-mailadres.",
    genericError: "Er ging iets mis. Probeer het opnieuw.",
    googleError: "Inloggen met Google is zojuist niet gelukt. Probeer het opnieuw.",
  },
} as const;
