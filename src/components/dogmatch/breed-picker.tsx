...
const copy = {
  ...
  de: {
    typeLabel: "Ist Ihr Hund eine Rasse oder eine Mischung?",
    typeHint: "Beides ist völlig in Ordnung — bei einer Mischung stützen wir uns einfach mehr auf Ihren Hund als auf ein Rassebuch.",
    purebred: "Eine Rasse",
    mixed: "Mischling",
    breedLabel: "Welche Rasse?",
    notFromList: "Nicht auf dieser Liste",
    breedOtherPlaceholder: "Terrier",
    mixBreedsLabel: "Kennen Sie einige der Rassen in der Mischung?",
    mixBreedsHint: "Wählen Sie so viele aus, wie Sie kennen. Wir nutzen sie nur als Hintergrund — wir tun nicht so, als wüssten wir genau, was Ihr Hund ist.",
    unknownMix: "Unbekannte Mischung",
    unknownMixHint: "Niemand weiß es, und das ist völlig in Ordnung. Alles funktioniert trotzdem.",
    mixOtherLabel: "Wie nennen Sie ihn?",
    mixOtherPlaceholder: "Terrier-Mischling aus dem Tierheim",
    observedLabel: "Wie würden Sie Ihren Hund beschreiben?",
    observedHint:
      "Das nutzen wir zuerst — Ihren eigenen Hund, nicht einen Rassedurchschnitt. Überspringen Sie, was Sie nicht sicher wissen.",
    skip: "Nicht sicher",
    scales: {
      ...
      trainability: { label: "Wie leicht er lernt", low: "Braucht Zeit", high: "Begreift schnell" },
      ...
      shedding: { label: "Fellwechsel", low: "Kaum welches", high: "Haare überall" },
      barking: { label: "Wie lautstark", low: "Ruhig", high: "Sehr bellfreudig" },
    },
  },
  fr: {
    typeLabel: "Votre chien est-il de race pure ou croisé ?",
    typeHint: "Les deux vont très bien — pour un croisement, nous nous appuyons simplement davantage sur votre chien que sur un livre de races.",
    ...
    mixBreedsHint: "Choisissez-en autant que vous connaissez. Nous les utilisons seulement comme contexte — nous ne prétendons pas savoir exactement ce qu'est votre chien.",
    ...
    mixOtherPlaceholder: "Croisé terrier venu du refuge",
    ...
    scales: {
      ...
      trainability: { label: "Facilité d'apprentissage", low: "Prend du temps", high: "Comprend vite" },
      sociability: { label: "Avec les gens et les chiens", low: "Réservé", high: "Adore tout le monde" },
      grooming: { label: "Entretien du pelage", low: "Un lavage et c'est fait", high: "Brossage quotidien" },
      shedding: { label: "Perte de poils", low: "Presque aucune", high: "Des poils partout" },
      barking: { label: "Tendance à aboyer", low: "Silencieux", high: "Aboie beaucoup" },
    },
  },
  nl: {
    typeLabel: "Is uw hond een rasechte hond of een kruising?",
    typeHint: "Beide zijn prima — bij een kruising steunen we gewoon meer op uw hond dan op een rassenboek.",
    purebred: "Eén ras",
    mixed: "Kruising",
    breedLabel: "Welk ras?",
    notFromList: "Staat niet op deze lijst",
    breedOtherPlaceholder: "Terriër",
    mixBreedsLabel: "Weet u welke rassen in de kruising zitten?",
    mixBreedsHint: "Kies er zoveel als u weet. We gebruiken ze alleen als achtergrond — we doen niet alsof we precies weten wat uw hond is.",
    unknownMix: "Onbekende kruising",
    unknownMixHint: "Niemand weet het, en dat is prima. Alles werkt nog steeds.",
    mixOtherLabel: "Hoe noemt u hem?",
    mixOtherPlaceholder: "Terriërkruising uit het asiel",
    observedLabel: "Hoe zou u uw hond omschrijven?",
    observedHint:
      "Dit gebruiken we als eerste — uw eigen hond, niet een rasgemiddelde. Sla over waarvan u niet zeker bent.",
    skip: "Niet zeker",
    scales: {
      ...
      shedding: { label: "Verharen", low: "Nauwelijks", high: "Haren overal" },
      barking: { label: "Hoe blafferig", low: "Stil", high: "Erg blafferig" },
    },
  },
} as const;
