...
const copy = {
  ...
  de: {
    ...
    ageStages: [
      ...
      { value: "adult", label: "Erwachsen", hint: "Irgendwo in den mittleren Jahren" },
  ...
  nl: {
    ...
    activities: [
      ...
      { value: "moderate", label: "Redelijk normaal", hint: "Ongeveer een uur per dag" },
      { value: "busy", label: "Altijd in beweging", hint: "Lange wandelingen, rennen, sport" },
    ],
    foodTypes: [
