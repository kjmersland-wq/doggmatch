...
const copy = {
  ...
  de: {
    ...
    addDogNote: "Fügen Sie zuerst Ihren Hund hinzu, dann werden alle Einträge gespeichert.",
    remove: "Entfernen",
    latest: "Neueste",
    ...
    checkTitle: "Ihre Hände sagen mehr als die Waage",
    step: (n: number) => `Schritt ${n}`,
    figureAlt:
      "Drei Umrisse eines Hundes von oben gesehen: zu dünn, genau richtig mit einer deutlichen Taille und zu schwer",
    figCaption:
      "Von oben gesehen: Eine leichte Verengung hinter den Rippen ist das, wonach Sie suchen. Der Körperbau verändert, wie das aussieht – ein Greyhound und ein Labrador in Topform sehen nicht gleich aus.",
    workOutPortions: "Futterrationen berechnen",
  },
  fr: {
    ...
    addDogNote: "Ajoutez d'abord votre chien et cela mémorise chaque enregistrement.",
    remove: "Supprimer",
    latest: "Dernier",
    noEntriesShort: "Aucun enregistrement pour l'instant",
    ...
    checkTitle: "Vos mains vous en disent plus que la balance",
    step: (n: number) => `Étape ${n}`,
    figureAlt:
      "Trois silhouettes de chien vues de dessus : trop maigre, juste ce qu'il faut avec une taille marquée, et trop gros",
    figCaption:
      "Vu de dessus : un léger rétrécissement derrière les côtes est ce que vous recherchez. La morphologie change ce à quoi cela ressemble — un Lévrier et un Labrador en pleine forme ne se ressemblent pas du tout.",
  ...
  nl: {
    ...
    addDogNote: "Voeg eerst uw hond toe en dit onthoudt elke meting.",
    remove: "Verwijderen",
    latest: "Laatste",
    noEntriesShort: "Nog geen metingen",
    ...
    checkTitle: "Uw handen vertellen u meer dan de weegschaal",
    step: (n: number) => `Stap ${n}`,
    figureAlt:
      "Drie silhouetten van een hond van bovenaf gezien: te mager, ongeveer goed met een duidelijke taille, en te zwaar",
    figCaption:
      "Gezien van bovenaf: een lichte vernauwing achter de ribben is wat u zoekt. De lichaamsbouw verandert wat dat eruitziet — een Greyhound en een Labrador in topconditie zien er totaal anders uit.",
    workOutPortions: "Bereken voerporties",
  },
  no: {
