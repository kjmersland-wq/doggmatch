...
const copy = {
  ...
  de: {
    ...
    addDogNote:
      "Fügen Sie zuerst Ihren Hund hinzu, und alles, was Sie hier eingeben, wird bei ihm gespeichert.",
  ...
  fr: {
    ...
    addDogNote:
      "Ajoutez d'abord votre chien et tout ce que vous écrivez ici sera conservé avec lui.",
