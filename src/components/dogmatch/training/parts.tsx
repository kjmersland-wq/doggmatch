...
const copy = {
  ...
  de: {
    level: {
      beginner: "Anfänger",
      building: "Baut Selbstvertrauen auf",
      intermediate: "Mittel",
      advanced: "Fortgeschritten",
    } as Record<Lesson["level"], string>,
    status: {
      "not-started": "Noch nicht begonnen",
      practising: "Wird geübt",
      "getting-there": "Kommt langsam",
      learned: "Gelernt",
    } as Record<SkillStatus, string>,
    howGoing: "Wie läuft's?",
    pause: "Pause",
  ...
  fr: {
    level: {
      beginner: "Débutant",
      building: "Renforce la confiance",
  ...
  nl: {
    level: {
      beginner: "Beginner",
      building: "Bouwt aan zelfvertrouwen",
