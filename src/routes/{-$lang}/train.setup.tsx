...
const copy = {
  ...
  de: {
    eyebrow: "Ihr Hund",
    title: "Erzählen Sie uns ein wenig von Ihrem Hund.",
    intro:
      "Nur damit das vorgeschlagene Training wirklich zu Ihnen beiden passt. Es bleibt auf diesem Gerät, und Sie können später alles ändern.",
    nameLabel: "Wie heißt er oder sie?",
    namePlaceholder: "Luna",
    ageLabel: "Wie alt ist Ihr Hund?",
    experienceLabel: "Wie viel Trainingserfahrung haben Sie schon?",
    levelLabel: "Und wo stehen Sie beide gerade?",
    goalsLabel: "Woran möchten Sie am liebsten gemeinsam arbeiten?",
    goalsHint: "Wählen Sie so viele, wie Sie möchten. Nichts ist endgültig.",
    notNow: "Nicht jetzt",
    ...
    experiences: [
      ...
      { value: "some" as const, label: "Ich hatte schon einen Hund", hint: "Sie kennen sich mit der Leckerlitasche aus" },
      { value: "lots" as const, label: "Ich habe schon einiges trainiert", hint: "Gerne etwas weiter gehen" },
    ],
    levels: [
      { value: "beginner" as const, label: "Wir fangen gerade erst an", hint: "Fast alles ist neu" },
      { value: "building" as const, label: "Einiges beginnt zu klappen", hint: "Manche Tage sind besser als andere" },
      { value: "intermediate" as const, label: "Die Grundlagen sitzen gut", hint: "Bereit für Ablenkungen" },
      { value: "advanced" as const, label: "Wir trainieren viel", hint: "Suchen nach mehr Herausforderung" },
    ],
  },
  fr: {
    eyebrow: "Votre chien",
    ...
    intro:
      "Uniquement pour que l'entraînement proposé vous convienne vraiment à tous les deux. Cela reste sur cet appareil, et vous pourrez tout modifier plus tard.",
    ...
    goalsLabel: "Sur quoi aimeriez-vous surtout travailler ensemble ?",
    ...
    ageStages: [
      ...
      { value: "adolescent" as const, label: "Un adolescent", hint: "Environ six mois à deux ans" },
      { value: "adult" as const, label: "Adulte", hint: "Quelque part dans les années intermédiaires" },
      { value: "senior" as const, label: "Qui prend de l'âge", hint: "Ralentit un peu" },
    ],
    experiences: [
      { value: "first-dog" as const, label: "C'est mon premier chien", hint: "Nous garderons tout simple" },
      { value: "some" as const, label: "J'ai déjà eu un chien", hint: "Vous savez manier la pochette à friandises" },
      { value: "lots" as const, label: "J'ai pas mal entraîné de chiens", hint: "Ravi d'aller un peu plus loin" },
    ],
    levels: [
      { value: "beginner" as const, label: "Nous débutons tout juste", hint: "Presque tout est nouveau" },
      { value: "building" as const, label: "Certaines choses commencent à venir", hint: "Certains jours sont meilleurs que d'autres" },
      { value: "intermediate" as const, label: "Les bases sont solides", hint: "Prêts pour les distractions" },
      { value: "advanced" as const, label: "Nous entraînons beaucoup", hint: "Nous cherchons un peu plus" },
    ],
  },
  nl: {
    eyebrow: "Uw hond",
    title: "Vertel ons iets over uw hond.",
    intro:
      "Alleen zodat de voorgestelde training echt bij u beiden past. Het blijft op dit apparaat, en u kunt alles later nog wijzigen.",
    nameLabel: "Hoe heet hij of zij?",
    namePlaceholder: "Luna",
    ageLabel: "Hoe oud is uw hond?",
    experienceLabel: "Hoeveel training heeft u al gedaan?",
    levelLabel: "En waar staan jullie nu?",
    goalsLabel: "Waar zou u het liefst samen aan werken?",
    goalsHint: "Kies er zoveel als u wilt. Niets ligt vast.",
    notNow: "Niet nu",
    save: "Opslaan en training starten",
    ageStages: [
      { value: "puppy" as const, label: "Een puppy", hint: "Tot ongeveer zes maanden" },
      { value: "adolescent" as const, label: "Een puberhond", hint: "Ongeveer zes maanden tot twee jaar" },
      { value: "adult" as const, label: "Volwassen", hint: "Ergens in de middelste jaren" },
      { value: "senior" as const, label: "Wordt ouder", hint: "Kalmeert een beetje" },
    ],
    experiences: [
      { value: "first-dog" as const, label: "Dit is mijn eerste hond", hint: "We houden alles eenvoudig" },
      { value: "some" as const, label: "Ik heb eerder een hond gehad", hint: "U kent het snoepzakje al" },
      { value: "lots" as const, label: "Ik heb al aardig wat getraind", hint: "Graag iets verder gaan" },
    ],
    levels: [
      { value: "beginner" as const, label: "We beginnen net", hint: "Bijna alles is nieuw" },
      { value: "building" as const, label: "Sommige dingen beginnen te lukken", hint: "Sommige dagen zijn beter dan andere" },
