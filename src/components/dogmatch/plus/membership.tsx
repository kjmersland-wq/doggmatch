...
const copy = {
  ...
  de: {
    ...
    signedInBody: "Sie sind angemeldet. Alles, was Sie über Ihren Hund eingetragen haben, ist weiterhin auf diesem Gerät gespeichert.",
    signOut: "Abmelden",
    guestBody: "Sie brauchen kein Konto, um DoggMatch zu nutzen. Nur für DoggMatch+ benötigen Sie eines.",
    signIn: "Anmelden",
    ...
    freeBodyPrefix: "Alles, was Sie heute sehen können, ist kostenlos.",
    freeBodySuffix: "fügt die Werkzeuge für den Alltag mit Ihrem Hund hinzu.",
    portalError: "Wir konnten Ihre Abrechnungsseite gerade nicht öffnen. Bitte versuchen Sie es erneut.",
  },
  fr: {
    you: "Vous",
    email: "E-mail",
    ...
    signedInBody: "Vous êtes connecté. Tout ce que vous avez renseigné sur votre chien est toujours enregistré sur cet appareil.",
    signOut: "Se déconnecter",
    guestBody: "Vous n'avez pas besoin de compte pour utiliser DoggMatch. Vous n'en avez besoin d'un que pour DoggMatch+.",
    signIn: "Se connecter",
    membership: "Adhésion",
    plan: "Formule",
    ...
    freeBodyPrefix: "Tout ce que vous pouvez voir aujourd'hui est gratuit.",
    freeBodySuffix: "ajoute les outils pour la vie quotidienne avec votre chien.",
    portalError: "Nous n'avons pas pu ouvrir votre page de facturation à l'instant. Veuillez réessayer.",
  },
  nl: {
    you: "U",
    email: "E-mail",
    ...
    signedInBody: "U bent aangemeld. Alles wat u over uw hond heeft ingevuld, staat nog steeds opgeslagen op dit apparaat.",
    signOut: "Afmelden",
    guestBody: "U heeft geen account nodig om DoggMatch te gebruiken. Alleen voor DoggMatch+ heeft u er een nodig.",
    signIn: "Aanmelden",
    ...
    freeBodyPrefix: "Alles wat u vandaag kunt zien is gratis.",
    freeBodySuffix: "voegt de tools voor het dagelijks leven met uw hond toe.",
    portalError: "We konden uw factureringspagina zojuist niet openen. Probeer het opnieuw.",
  },
} as const;
