...
const copy = {
  en: {
    ...
    sections: {
      whoWeAre: {
        title: "Who we are",
        p1: 'DoggMatch is built and run by KM TECH LABS, org.nr. 934 044 029, Kristiansand, Norway. When we say "we" or "us" below, that\'s who we mean. When we say "you", we mean whoever is using the site.',
      },
      whatItIs: {
        title: "What DoggMatch is",
        p1: "DoggMatch helps you work out which dog might suit your life, and helps you look after the dog you already have. Everything we show you comes from a transparent calculation based on what you tell us and what each breed typically needs. It is general guidance, not a professional assessment.",
      },
      notAdvice: {
        title: "Important: this is not veterinary or legal advice",
        p1: "Our health, nutrition, training and travel material is general information. Every dog is different. Always talk to your vet about anything medical, and always check the official rules of the countries you're travelling to and from — border and import requirements change, and only the authorities can confirm what applies to you. You are responsible for decisions you make about your dog.",
      },
      account: {
        title: "Your account",
        p1: "Most of DoggMatch works without an account. If you create one, keep your sign-in details to yourself, give us accurate information, and let us know if you think someone else has got into your account. You need to be at least 16 years old. You can close your account whenever you like.",
      },
      membership: {
      ...
      withdraw: {
        ...
        p2: "Because DoggMatch+ gives you immediate access to digital content, you agree that we start delivering straight away. If you then withdraw within the 14 days, we may deduct a fair amount for the part of the period you've already used.",
      },
      use: {
      ...
      changes: {
        ...
        p1: "If we change these terms in a way that matters to you, we'll let members know by email at least 30 days beforehand. Carrying on using DoggMatch after that means you accept the new terms.",
      },
      law: {
        title: "Law and disputes",
        p1: "These terms are governed by Norwegian law, with Kristiansand tingrett as the ordinary venue. If you're a consumer, you keep the protection of the mandatory law of the country you live in, and you can bring a case there.",
        p2Before:
          "You can also take a complaint to the Norwegian Consumer Authority (Forbrukertilsynet)/Forbrukerrådet, or use the European Commission's online dispute resolution platform. We'd much rather you just",
  ...
  no: {
    ...
    sections: {
      whoWeAre: {
        title: "Hvem vi er",
        p1: "DoggMatch er bygget og driftet av KM TECH LABS, org.nr. 934 044 029, Kristiansand, Norge. Når vi sier «vi» eller «oss» under, er det dette vi mener. Når vi sier «du», mener vi den som bruker siden.",
      },
      whatItIs: {
        title: "Hva DoggMatch er",
        p1: "DoggMatch hjelper deg å finne ut hvilken hund som kan passe livet ditt, og hjelper deg å ta vare på hunden du allerede har. Alt vi viser deg kommer fra en gjennomsiktig beregning basert på det du forteller oss og hva hver rase normalt trenger. Det er generell veiledning, ikke en profesjonell vurdering.",
      },
      notAdvice: {
        title: "Viktig: dette er ikke veterinær- eller juridisk rådgivning",
        p1: "Vårt innhold om helse, ernæring, trening og reise er generell informasjon. Hver hund er forskjellig. Snakk alltid med veterinæren din om alt som er medisinsk, og sjekk alltid de offisielle reglene for landene du reiser til og fra — grense- og importkrav endrer seg, og bare myndighetene kan bekrefte hva som gjelder for deg. Du er selv ansvarlig for beslutninger du tar om hunden din.",
      },
      account: {
        title: "Din konto",
        p1: "Det meste av DoggMatch fungerer uten konto. Hvis du oppretter en, hold innloggingsopplysningene dine for deg selv, gi oss korrekt informasjon, og gi beskjed hvis du tror noen andre har fått tilgang til kontoen din. Du må være minst 16 år. Du kan avslutte kontoen din når du vil.",
      },
      membership: {
      ...
      withdraw: {
        ...
        p2: "Fordi DoggMatch+ gir deg umiddelbar tilgang til digitalt innhold, godtar du at vi begynner å levere med en gang. Hvis du deretter angrer innen 14-dagersfristen, kan vi trekke fra et rimelig beløp for den delen av perioden du allerede har brukt.",
      },
      use: {
      ...
      changes: {
        ...
        p1: "Hvis vi endrer disse vilkårene på en måte som betyr noe for deg, gir vi medlemmer beskjed per e-post minst 30 dager i forveien. Fortsetter du å bruke DoggMatch etter det, betyr det at du godtar de nye vilkårene.",
      },
      law: {
        title: "Lovvalg og tvister",
        p1: "Disse vilkårene er underlagt norsk rett, med Kristiansand tingrett som ordinært verneting. Er du forbruker, beholder du beskyttelsen av ufravikelig lovgivning i landet du bor i, og du kan reise sak der.",
        p2Before:
          "Du kan også bringe en klage til Forbrukertilsynet/Forbrukerrådet, eller bruke EU-kommisjonens nettbaserte tvisteløsningsplattform. Vi vil mye heller at du bare",
  ...
  pl: {
    ...
    sections: {
      whoWeAre: {
        title: "Kim jesteśmy",
        p1: "DoggMatch jest budowany i prowadzony przez KM TECH LABS, nr org. 934 044 029, Kristiansand, Norwegia. Gdy poniżej mówimy „my” lub „nas”, mamy na myśli właśnie ich. Gdy mówimy „ty”, mamy na myśli osobę korzystającą ze strony.",
      },
      whatItIs: {
        title: "Czym jest DoggMatch",
        p1: "DoggMatch pomaga ci ustalić, jaki pies mógłby pasować do twojego życia, oraz pomaga zająć się psem, którego już masz. Wszystko, co ci pokazujemy, pochodzi z przejrzystego obliczenia opartego na tym, co nam powiesz, i na tym, czego zwykle potrzebuje dana rasa. To ogólne wskazówki, a nie profesjonalna ocena.",
      },
      notAdvice: {
        title: "Ważne: to nie jest porada weterynaryjna ani prawna",
        p1: "Nasze materiały dotyczące zdrowia, żywienia, szkolenia i podróży to informacje ogólne. Każdy pies jest inny. Zawsze rozmawiaj ze swoim weterynarzem w sprawach medycznych i zawsze sprawdzaj oficjalne przepisy krajów, do których i z których podróżujesz — wymagania graniczne i importowe się zmieniają, a tylko władze mogą potwierdzić, co dotyczy ciebie. Ty ponosisz odpowiedzialność za decyzje dotyczące twojego psa.",
      },
      account: {
        title: "Twoje konto",
        p1: "Większość funkcji DoggMatch działa bez konta. Jeśli je założysz, zachowaj dane logowania dla siebie, podaj nam dokładne informacje i poinformuj nas, jeśli podejrzewasz, że ktoś inny uzyskał dostęp do twojego konta. Musisz mieć co najmniej 16 lat. Możesz zamknąć konto w dowolnym momencie.",
      },
      membership: {
      ...
      withdraw: {
        ...
        p2: "Ponieważ DoggMatch+ daje ci natychmiastowy dostęp do treści cyfrowych, zgadzasz się, że zaczynamy dostarczać usługę od razu. Jeśli następnie odstąpisz w ciągu 14 dni, możemy potrącić uczciwą kwotę za tę część okresu, z której już skorzystałeś.",
      },
      use: {
      ...
      content: {
        ...
        p1: "Nazwa DoggMatch, logo, wygląd, materiały pisemne, treści o rasach i logika dopasowania należą do KM TECH LABS i są chronione prawem autorskim i prawem znaków towarowych. Możesz z nich korzystać do własnego, osobistego, niekomercyjnego użytku — w tym drukować własne dokumenty i kartę członkowską. Wszystko, co tworzysz w DoggMatch, takie jak profile psów i notatki, pozostaje twoje.",
      },
      availability: {
        title: "Dostępność",
        p1: "Ciężko pracujemy, aby DoggMatch działał, ale nie obiecujemy, że nigdy nie będzie niedostępny. Możemy aktualizować, zmieniać lub wycofywać funkcje. Jeśli kiedykolwiek zamkniemy płatną funkcję, na którą jesteś zapisany, zwrócimy niewykorzystaną część twojego okresu.",
      },
      liability: {
        title: "Odpowiedzialność",
        p1: "Nic tutaj nie ogranicza twoich ustawowych praw konsumenckich, i nic nie ogranicza naszej odpowiedzialności za śmierć, uszkodzenie ciała, rażące niedbalstwo lub umyślne działanie. Poza tym, w zakresie dozwolonym przez prawo, nie ponosimy odpowiedzialności za szkody pośrednie lub następcze, a nasza całkowita odpowiedzialność jest ograniczona do kwoty, którą zapłaciłeś nam w ciągu 12 miesięcy poprzedzających roszczenie.",
      },
      privacy: {
        title: "Prywatność",
      ...
      changes: {
        ...
        p1: "Jeśli zmienimy te warunki w sposób, który ma dla ciebie znaczenie, poinformujemy członków e-mailem co najmniej 30 dni wcześniej. Dalsze korzystanie z DoggMatch po tym czasie oznacza akceptację nowych warunków.",
      },
      law: {
        title: "Prawo właściwe i spory",
        p1: "Niniejsze warunki podlegają prawu norweskiemu, z sądem Kristiansand tingrett jako właściwym sądem zwyczajnym. Jeśli jesteś konsumentem, zachowujesz ochronę wynikającą z bezwzględnie obowiązujących przepisów kraju, w którym mieszkasz, i możesz tam wnieść sprawę.",
        p2Before:
          "Możesz też złożyć skargę do norweskiego Urzędu Ochrony Konsumentów (Forbrukertilsynet)/Forbrukerrådet lub skorzystać z internetowej platformy rozstrzygania sporów Komisji Europejskiej. Wolelibyśmy jednak, żebyś po prostu",
  ...
  dk: {
    ...
    sections: {
      whoWeAre: {
        title: "Hvem vi er",
        p1: 'DoggMatch er bygget og drevet af KM TECH LABS, CVR-nr. 934 044 029, Kristiansand, Norge. Når vi siger "vi" eller "os" nedenfor, er det dem, vi mener. Når vi siger "du", mener vi den, der bruger siden.',
      },
      whatItIs: {
        title: "Hvad DoggMatch er",
        p1: "DoggMatch hjælper dig med at finde ud af, hvilken hund der kan passe til dit liv, og hjælper dig med at passe på den hund, du allerede har. Alt, hvad vi viser dig, kommer fra en gennemsigtig beregning baseret på det, du fortæller os, og hvad hver race typisk har brug for. Det er generel vejledning, ikke en professionel vurdering.",
      },
      notAdvice: {
        title: "Vigtigt: dette er ikke veterinær- eller juridisk rådgivning",
        p1: "Vores materiale om sundhed, ernæring, træning og rejser er generel information. Hver hund er forskellig. Tal altid med din dyrlæge om alt medicinsk, og tjek altid de officielle regler for de lande, du rejser til og fra — grænse- og indførselskrav ændrer sig, og kun myndighederne kan bekræfte, hvad der gælder for dig. Du er selv ansvarlig for beslutninger, du træffer om din hund.",
      },
      account: {
        title: "Din konto",
        p1: "Det meste af DoggMatch fungerer uden en konto. Opretter du en, så hold dine login-oplysninger for dig selv, giv os korrekte oplysninger, og fortæl os det, hvis du tror, nogen andre er kommet ind på din konto. Du skal være mindst 16 år. Du kan lukke din konto, når du vil.",
      },
      membership: {
      ...
      withdraw: {
        ...
        p2: "Fordi DoggMatch+ giver dig øjeblikkelig adgang til digitalt indhold, accepterer du, at vi begynder at levere med det samme. Hvis du derefter fortryder inden for de 14 dage, kan vi trække et rimeligt beløb fra for den del af perioden, du allerede har brugt.",
      },
      use: {
      ...
      changes: {
        ...
        p1: "Hvis vi ændrer disse vilkår på en måde, der betyder noget for dig, giver vi medlemmer besked via e-mail mindst 30 dage i forvejen. Fortsætter du med at bruge DoggMatch derefter, betyder det, at du accepterer de nye vilkår.",
      },
      law: {
        title: "Lovvalg og tvister",
        p1: "Disse vilkår er underlagt norsk ret, med Kristiansand tingrett som ordinært værneting. Er du forbruger, beholder du beskyttelsen af ufravigelig lovgivning i det land, du bor i, og du kan anlægge sag der.",
        p2Before:
          "Du kan også indgive en klage til det norske Forbrugertilsyn (Forbrukertilsynet)/Forbrukerrådet, eller bruge EU-Kommissionens onlineplatform for tvistbilæggelse. Vi vil meget hellere have, at du bare",
  ...
  se: {
    ...
    sections: {
      whoWeAre: {
        title: "Vilka vi är",
        p1: 'DoggMatch byggs och drivs av KM TECH LABS, org.nr 934 044 029, Kristiansand, Norge. När vi säger "vi" eller "oss" nedan menar vi dem. När vi säger "du" menar vi den som använder sidan.',
      },
      whatItIs: {
        title: "Vad DoggMatch är",
        p1: "DoggMatch hjälper dig att ta reda på vilken hund som kan passa ditt liv, och hjälper dig att ta hand om hunden du redan har. Allt vi visar dig kommer från en transparent beräkning baserad på vad du berättar för oss och vad varje ras vanligtvis behöver. Det är allmän vägledning, inte en professionell bedömning.",
      },
      notAdvice: {
        title: "Viktigt: det här är inte veterinär- eller juridisk rådgivning",
        p1: "Vårt material om hälsa, näring, träning och resor är allmän information. Varje hund är olik. Prata alltid med din veterinär om allt medicinskt, och kontrollera alltid de officiella reglerna för länderna du reser till och från — gräns- och importkrav ändras, och bara myndigheterna kan bekräfta vad som gäller för dig. Du ansvarar själv för beslut du fattar om din hund.",
      },
      account: {
        title: "Ditt konto",
        p1: "Det mesta av DoggMatch fungerar utan konto. Om du skapar ett, håll dina inloggningsuppgifter för dig själv, ge oss korrekt information, och meddela oss om du tror att någon annan har kommit åt ditt konto. Du måste vara minst 16 år. Du kan stänga ditt konto när du vill.",
      },
      membership: {
      ...
      withdraw: {
        ...
        p2: "Eftersom DoggMatch+ ger dig omedelbar tillgång till digitalt innehåll godkänner du att vi börjar leverera direkt. Om du sedan ångrar dig inom 14 dagar kan vi dra av ett skäligt belopp för den del av perioden du redan har använt.",
      },
      use: {
      ...
      changes: {
        ...
        p1: "Om vi ändrar dessa villkor på ett sätt som spelar roll för dig meddelar vi medlemmar via e-post minst 30 dagar i förväg. Att fortsätta använda DoggMatch därefter innebär att du godkänner de nya villkoren.",
      },
      law: {
        title: "Lagval och tvister",
        p1: "Dessa villkor styrs av norsk lag, med Kristiansand tingrett som ordinarie forum. Är du konsument behåller du skyddet av tvingande lagstiftning i landet du bor i, och du kan väcka talan där.",
        p2Before:
          "Du kan också klaga till den norska Konsumentmyndigheten (Forbrukertilsynet)/Forbrukerrådet, eller använda EU-kommissionens plattform för onlinetvistlösning. Vi föredrar mycket hellre att du bara",
    ...
    sections: {
      whoWeAre: {
        title: "Keitä olemme",
        p1: 'DoggMatchin rakentaa ja sitä ylläpitää KM TECH LABS, y-tunnus 934 044 029, Kristiansand, Norja. Kun sanomme jäljempänä "me" tai "meidän", tarkoitamme heitä. Kun sanomme "sinä", tarkoitamme sivustoa käyttävää henkilöä.',
      },
      whatItIs: {
        title: "Mikä DoggMatch on",
        p1: "DoggMatch auttaa sinua selvittämään, mikä koira voisi sopia elämääsi, ja auttaa sinua huolehtimaan jo omistamastasi koirasta. Kaikki näyttämämme perustuu läpinäkyvään laskelmaan, joka pohjautuu kertomiisi tietoihin ja siihen, mitä kukin rotu tyypillisesti tarvitsee. Se on yleistä ohjeistusta, ei ammatillista arviota.",
      },
      notAdvice: {
        title: "Tärkeää: tämä ei ole eläinlääketieteellistä tai oikeudellista neuvontaa",
        p1: "Terveys-, ravitsemus-, koulutus- ja matkustusaineistomme on yleistä tietoa. Jokainen koira on erilainen. Keskustele aina eläinlääkärisi kanssa kaikesta lääketieteellisestä, ja tarkista aina niiden maiden viralliset säännöt, joihin ja joista matkustat — raja- ja tuontivaatimukset muuttuvat, ja vain viranomaiset voivat vahvistaa, mitä sinuun sovelletaan. Olet itse vastuussa koiraasi koskevista päätöksistäsi.",
      },
      account: {
        title: "Tilisi",
        p1: "Suurin osa DoggMatchista toimii ilman tiliä. Jos luot sellaisen, pidä kirjautumistietosi itselläsi, anna meille oikeat tiedot, ja kerro meille, jos epäilet jonkun muun päässeen tilillesi. Sinun on oltava vähintään 16-vuotias. Voit sulkea tilisi milloin tahansa.",
      },
      membership: {
      ...
      withdraw: {
        ...
        p2: "Koska DoggMatch+ antaa sinulle välittömän pääsyn digitaaliseen sisältöön, hyväksyt, että aloitamme toimituksen heti. Jos sitten peruutat 14 päivän kuluessa, saatamme vähentää kohtuullisen summan siitä osasta jaksoa, jonka olet jo käyttänyt.",
      },
      use: {
      ...
      changes: {
        ...
        p1: "Jos muutamme näitä ehtoja tavalla, joka on sinulle merkityksellinen, kerromme jäsenille siitä sähköpostitse vähintään 30 päivää etukäteen. DoggMatchin käytön jatkaminen tämän jälkeen tarkoittaa, että hyväksyt uudet ehdot.",
      },
      law: {
        title: "Sovellettava laki ja riidat",
        p1: "Näihin ehtoihin sovelletaan Norjan lakia, ja Kristiansandin käräjäoikeus (tingrett) on tavanomainen oikeuspaikka. Jos olet kuluttaja, säilytät asuinmaasi pakottavan lainsäädännön suojan, ja voit nostaa kanteen siellä.",
        p2Before:
          "Voit myös viedä valituksen Norjan kuluttajaviranomaiselle (Forbrukertilsynet)/Forbrukerrådetille, tai käyttää Euroopan komission verkkovälitteistä riidanratkaisualustaa. Toivoisimme kuitenkin paljon mieluummin, että",
  ...
  de: {
    ...
    sections: {
      ...
      withdraw: {
        ...
        p1After:
          "innerhalb von 14 Tagen nach dem Abonnieren Bescheid, und wir erstatten dir das Geld.",
        p2: "Da dir DoggMatch+ sofortigen Zugang zu digitalen Inhalten gewährt, stimmst du zu, dass wir sofort mit der Bereitstellung beginnen. Widerrufst du dann innerhalb der 14 Tage, können wir einen angemessenen Betrag für den Teil des Zeitraums abziehen, den du bereits genutzt hast.",
      },
      use: {
      ...
      content: {
        ...
        p1: "Der Name DoggMatch, das Logo, das Design, die schriftlichen Materialien, die Rasseinhalte und die Matching-Logik gehören KM TECH LABS und sind durch Urheber- und Markenrecht geschützt. Du darfst sie für deinen eigenen persönlichen, nicht-kommerziellen Gebrauch nutzen — einschließlich des Ausdruckens eigener Dokumente und deiner Mitgliedskarte. Alles, was du in DoggMatch erstellst, wie deine Hundeprofile und Notizen, bleibt dein Eigentum.",
      },
      availability: {
        title: "Verfügbarkeit",
        p1: "Wir arbeiten hart daran, DoggMatch verfügbar zu halten, versprechen aber nicht, dass es niemals ausfällt. Wir können Funktionen aktualisieren, ändern oder einstellen. Sollten wir jemals eine kostenpflichtige Funktion einstellen, die du abonniert hast, erstatten wir dir den ungenutzten Teil deines Zeitraums.",
      },
      liability: {
        title: "Haftung",
        p1: "Nichts hier schränkt deine gesetzlichen Verbraucherrechte ein, und nichts schränkt unsere Haftung für Tod, Personenschäden, grobe Fahrlässigkeit oder Vorsatz ein. Darüber hinaus, und soweit gesetzlich zulässig, haften wir nicht für indirekte oder Folgeschäden, und unsere Gesamthaftung ist auf den Betrag begrenzt, den du uns in den 12 Monaten vor dem Anspruch gezahlt hast.",
      },
      privacy: {
        title: "Datenschutz",
      ...
      changes: {
        ...
        p1: "Ändern wir diese Bedingungen auf eine Weise, die für dich von Bedeutung ist, informieren wir Mitglieder mindestens 30 Tage vorher per E-Mail. Nutzt du DoggMatch danach weiter, bedeutet das, dass du die neuen Bedingungen akzeptierst.",
      },
      law: {
        title: "Recht und Streitigkeiten",
        p1: "Diese Bedingungen unterliegen norwegischem Recht, mit dem Kristiansand tingrett als ordentlichem Gerichtsstand. Bist du Verbraucher, behältst du den Schutz des zwingenden Rechts deines Wohnsitzlandes, und du kannst dort klagen.",
        p2Before:
          "Du kannst dich auch bei der norwegischen Verbraucherbehörde (Forbrukertilsynet)/Forbrukerrådet beschweren oder die Online-Streitbeilegungsplattform der Europäischen Kommission nutzen. Uns wäre es viel lieber, wenn du zuerst",
  ...
  fr: {
    ...
    sections: {
      ...
      withdraw: {
        ...
        p2: "Comme DoggMatch+ vous donne un accès immédiat au contenu numérique, vous acceptez que nous commencions à le fournir immédiatement. Si vous vous rétractez ensuite dans les 14 jours, nous pourrons déduire un montant raisonnable pour la partie de la période déjà utilisée.",
      },
      use: {
      ...
      changes: {
        ...
        p1: "Si nous modifions ces conditions d'une manière qui vous concerne, nous en informerons les membres par e-mail au moins 30 jours à l'avance. Continuer à utiliser DoggMatch après cela signifie que vous acceptez les nouvelles conditions.",
      },
      law: {
        title: "Droit applicable et litiges",
        p1: "Ces conditions sont régies par le droit norvégien, avec le tribunal de Kristiansand (tingrett) comme juridiction ordinaire. Si vous êtes consommateur, vous conservez la protection des dispositions impératives du pays où vous résidez, et vous pouvez y intenter une action.",
        p2Before:
          "Vous pouvez également porter plainte auprès de l'autorité norvégienne de la consommation (Forbrukertilsynet)/Forbrukerrådet, ou utiliser la plateforme de règlement en ligne des litiges de la Commission européenne. Nous préférerions cependant de loin que vous",
  ...
  nl: {
    ...
    sections: {
      whoWeAre: {
        title: "Wie wij zijn",
        p1: 'DoggMatch wordt gebouwd en beheerd door KM TECH LABS, org.nr. 934 044 029, Kristiansand, Noorwegen. Wanneer we hieronder "wij" of "ons" zeggen, bedoelen we hen. Wanneer we "jij" zeggen, bedoelen we wie de site ook gebruikt.',
      },
      whatItIs: {
        title: "Wat DoggMatch is",
        p1: "DoggMatch helpt je bepalen welke hond bij jouw leven zou kunnen passen, en helpt je zorgen voor de hond die je al hebt. Alles wat we je laten zien komt voort uit een transparante berekening op basis van wat je ons vertelt en wat elk ras doorgaans nodig heeft. Het is algemene begeleiding, geen professionele beoordeling.",
      },
      notAdvice: {
        title: "Belangrijk: dit is geen diergeneeskundig of juridisch advies",
        p1: "Ons materiaal over gezondheid, voeding, training en reizen is algemene informatie. Elke hond is anders. Praat altijd met je dierenarts over medische zaken, en controleer altijd de officiële regels van de landen waar je heen en vandaan reist — grens- en importvereisten veranderen, en alleen de autoriteiten kunnen bevestigen wat voor jou geldt. Je bent zelf verantwoordelijk voor beslissingen die je over je hond neemt.",
      },
      account: {
        title: "Jouw account",
      ...
      withdraw: {
        ...
        p2: "Omdat DoggMatch+ je onmiddellijke toegang geeft tot digitale content, ga je ermee akkoord dat we direct beginnen met leveren. Als je vervolgens binnen de 14 dagen herroept, kunnen we een redelijk bedrag aftrekken voor het deel van de periode dat je al hebt gebruikt.",
      },
      use: {
      ...
      content: {
        ...
        p1: "De naam DoggMatch, het logo, het ontwerp, het geschreven materiaal, de rasinhoud en de matchlogica zijn eigendom van KM TECH LABS en worden beschermd door auteursrecht en merkenrecht. Je mag ze gebruiken voor je eigen persoonlijke, niet-commerciële gebruik — inclusief het afdrukken van je eigen documenten en ledenkaart. Alles wat je in DoggMatch maakt, zoals je hondprofielen en notities, blijft van jou.",
      },
      availability: {
        title: "Beschikbaarheid",
        p1: "We werken hard om DoggMatch beschikbaar te houden, maar beloven niet dat het nooit uitvalt. We kunnen functies bijwerken, wijzigen of stopzetten. Als we ooit een betaalde functie waarop je bent geabonneerd stopzetten, betalen we het ongebruikte deel van je periode terug.",
      },
      liability: {
        title: "Aansprakelijkheid",
        p1: "Niets hier beperkt je wettelijke consumentenrechten, en niets beperkt onze aansprakelijkheid voor overlijden, persoonlijk letsel, grove nalatigheid of opzet. Daarbuiten, en voor zover de wet dit toestaat, zijn we niet aansprakelijk voor indirecte of gevolgschade, en is onze totale aansprakelijkheid beperkt tot wat je ons hebt betaald in de 12 maanden voorafgaand aan de claim.",
      },
      privacy: {
        title: "Privacy",
      ...
      changes: {
        ...
        p1: "Als we deze voorwaarden op een manier wijzigen die voor jou van belang is, laten we leden dit minstens 30 dagen van tevoren per e-mail weten. Als je DoggMatch daarna blijft gebruiken, betekent dit dat je de nieuwe voorwaarden accepteert.",
      },
      law: {
        title: "Recht en geschillen",
        p1: "Deze voorwaarden worden beheerst door Noors recht, met de Kristiansand tingrett als gewone bevoegde rechtbank. Als je consument bent, behoud je de bescherming van het dwingende recht van het land waarin je woont, en kun je daar een zaak aanspannen.",
        p2Before:
          "Je kunt ook een klacht indienen bij de Noorse consumentenautoriteit (Forbrukertilsynet)/Forbrukerrådet, of het onlineplatform voor geschillenbeslechting van de Europese Commissie gebruiken. We zouden het echter veel liever hebben dat je eerst",
