...
const copy = {
  ...
  de: {
    ...
    backBody: "Scanne den Code oder besuche doggmatch.com/verify und gib die Mitglieds-ID unten ein.",
    fineprint: "Diese Karte gehört der auf der Vorderseite genannten Person. Es ist keine Zahlungskarte.",
    verifyAlt: (id: string) => `Verifizierungscode für ${id}`,
  },
  fr: {
    plusMember: "+ Membre",
    member: "Membre",
    ...
    backBody: "Scannez le code, ou rendez-vous sur doggmatch.com/verify et saisissez le numéro de membre ci-dessous.",
  ...
  nl: {
    ...
    checkThisCard: "Controleer deze kaart",
    backBody: "Scan de code, of ga naar doggmatch.com/verify en typ het lidmaatschaps-ID hieronder in.",
    fineprint: "Deze kaart is van de persoon die op de voorzijde staat. Het is geen betaalkaart.",
