...
const copy = {
  ...
  dk: {
    ...
    reset: "Nulstil",
    goodOne: "Godt klaret",
    rewardsGiven: "belønninger givet",
  },
  se: {
    level: {
      beginner: "Nybörjare",
      building: "Bygger självförtroende",
      intermediate: "Medel",
      advanced: "Avancerad",
    } as Record<Lesson["level"], string>,
    status: {
      "not-started": "Inte påbörjad",
      practising: "Övar på det",
      "getting-there": "Nästan där",
      learned: "Kan det",
    } as Record<SkillStatus, string>,
    howGoing: "Hur går det?",
    pause: "Paus",
    startTimer: "Starta timer",
    resume: "Fortsätt",
    reset: "Återställ",
    goodOne: "Bra jobbat",
    rewardsGiven: "belöningar givna",
  },
  fi: {
    level: {
      beginner: "Aloittelija",
      building: "Rakentaa itseluottamusta",
      intermediate: "Keskitaso",
      advanced: "Edistynyt",
    } as Record<Lesson["level"], string>,
    status: {
      "not-started": "Ei aloitettu",
      practising: "Harjoittelee",
      "getting-there": "Melkein siellä",
      learned: "Osaa",
    } as Record<SkillStatus, string>,
    howGoing: "Miten menee?",
    pause: "Tauko",
    startTimer: "Käynnistä ajastin",
    resume: "Jatka",
    reset: "Nollaa",
    goodOne: "Hyvin tehty",
    rewardsGiven: "palkintoa annettu",
  },
  de: {
    level: {
      beginner: "Anfänger",
      building: "Selbstvertrauen aufbauen",
    ...
    status: {
      ...
      practising: "In Übung",
      "getting-there": "Fast geschafft",
      learned: "Beherrscht",
    } as Record<SkillStatus, string>,
    howGoing: "Wie läuft es?",
    pause: "Pause",
    startTimer: "Timer starten",
    resume: "Fortsetzen",
    reset: "Zurücksetzen",
    goodOne: "Gut gemacht",
    rewardsGiven: "Belohnungen gegeben",
  },
  fr: {
    level: {
      beginner: "Débutant",
      building: "En construction de la confiance",
      intermediate: "Intermédiaire",
      advanced: "Avancé",
    } as Record<Lesson["level"], string>,
    status: {
      "not-started": "Pas commencé",
      practising: "En cours d'entraînement",
      "getting-there": "Presque là",
      learned: "Acquis",
    } as Record<SkillStatus, string>,
    howGoing: "Comment ça se passe ?",
    pause: "Pause",
  ...
  nl: {
    level: {
      beginner: "Beginner",
      building: "Zelfvertrouwen opbouwen",
      intermediate: "Gevorderd",
      advanced: "Ver gevorderd",
    } as Record<Lesson["level"], string>,
    status: {
      "not-started": "Nog niet begonnen",
      practising: "Aan het oefenen",
      "getting-there": "Bijna zover",
      learned: "Beheerst",
    } as Record<SkillStatus, string>,
    howGoing: "Hoe gaat het?",
    pause: "Pauze",
    startTimer: "Timer starten",
    resume: "Hervatten",
    reset: "Resetten",
    goodOne: "Goed gedaan",
    rewardsGiven: "beloningen gegeven",
  },
} as const;
