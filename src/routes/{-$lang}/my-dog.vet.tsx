...
const copy = {
  ...
  de: {
    ...
    printIt: "Ausdrucken",
    addDogNote:
      "Fügen Sie zuerst Ihren Hund hinzu, wenn Sie möchten, dass dies für das nächste Mal aufbewahrt wird.",
    visitsSavedTitle: "Gespeicherte Besuche",
    noVisits:
      "Noch nichts gespeichert. Wenn Sie einmal dort waren, bewahren Sie die Notizen hier auf – es hilft, zurückzublicken.",
    remove: "Entfernen",
    vetNote:
  ...
  fr: {
    ...
    printIt: "L'imprimer",
    addDogNote:
      "Ajoutez d'abord votre chien si vous souhaitez que cela soit conservé pour la prochaine fois.",
    visitsSavedTitle: "Visites que vous avez enregistrées",
    noVisits:
      "Rien n'est encore enregistré. Une fois que vous y serez allé, conservez les notes ici — cela aide à regarder en arrière.",
    remove: "Supprimer",
    vetNote:
  ...
  nl: {
    ...
    noVisits:
      "Nog niets opgeslagen. Als u geweest bent, bewaar de aantekeningen hier — het helpt om terug te kijken.",
    remove: "Verwijderen",
    vetNote:
