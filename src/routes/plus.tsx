...
const copy = {
  ...
  pl: {
    ...
    membership: {
      ...
      monthlyPrice: "34,99 zł",
      monthlyUnit: "/ miesiąc",
      monthlyBody: "Wszystko w DoggMatch+, miesiąc po miesiącu.",
      monthlyJoin: "Dołącz miesięcznie",
      yearlyLabel: "Rocznie",
      bestValue: "Najlepsza oferta",
      yearlyPrice: "259,99 zł",
      yearlyUnit: "/ rok",
      yearlyHighlight: "Tylko 22 zł miesięcznie przy rozliczeniu rocznym",
      yearlyBody: "Oszczędzasz 159,89 zł rocznie w porównaniu z płatnością miesięczną.",
